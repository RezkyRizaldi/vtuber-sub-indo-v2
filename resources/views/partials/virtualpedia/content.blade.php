        ...
        <div class="row d-flex justify-content-md-center">
          <div class="col-12 col-md-8 order-2 order-md-0">
            ...
            <div class="tab-content" id="pills-tabContent">
              @foreach ($affiliationGen as $key => $aff)
                <div class="tab-pane fade show {{ $key == 0 ? 'active' : '' }}" id="pills-{{ $aff->id }}"
                  role="tabpanel" aria-labelledby="pills-{{ $aff->id }}-tab">
                  <div class="row mb-5">
                    <div class="col-12">
          ...
          <div class="col-12 col-md-4 col-xl-3 offset-0 offset-xl-1">
            <div class="virtualpedia_sorter mb-5 mb-md-0 rounded-3 overflow-auto fw-bold position-sticky shadow">
              ...
              <div class="input-group mb-3">
                <input id="search" type="search" class="form-control form_border" placeholder="Search here..."
                  title="Search here..." aria-label="Search here..." aria-describedby="btnSearch">
