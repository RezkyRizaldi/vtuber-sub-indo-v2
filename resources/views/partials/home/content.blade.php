...
<section data-anchor="about" id="about">
  <div class="container">
    <div class="row mb-3 text-center">
      <div class="col">
        <h2>
        @if (@$local) @lang('data.title.about.heading') @else Tentang Kami
          @endif
        </h2>
      </div>
    </div>
    <div class="row justify-content-around fs-5 text-center">
      <div class="col-md-12">
        <p class="mb-5">
        @if (@$local) @lang('data.desc') @else Vtuber Sub Indo adalah sebuah
            komunitas Clipper yang mewadahi para Clipper Vtuber. Tujuan Vtuber Sub Indo yaitu menjadi garda terdepan
            Channel Clip Vtuber ber-subtitle Indonesia untuk menarik para penonton masuk
      ...
      <div class="col-12 col-lg-6 col-xl-8">
        <div class="swiper-container">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                <iframe src="https://www.youtube.com/embed/X9zw0QF12Kc?rel=0" title="Sakura Miko Debut Video"
                  allowfullscreen></iframe>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                <iframe src="https://www.youtube.com/embed/Y8o4goeVM0o?rel=0" title="Sakura Miko Debut Video"
                  allowfullscreen></iframe>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                <iframe src="https://www.youtube.com/embed/HiLnCY9qjSo?rel=0" title="Sakura Miko Debut Video"
                  allowfullscreen></iframe>
              </div>
            </div>
            <div class="swiper-slide">
              <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                <iframe src="https://www.youtube.com/embed/uRB1G0cKpIk?rel=0" title="Sakura Miko Debut Video"
                  allowfullscreen></iframe>
              </div>
            </div>
          </div>
...
<section data-anchor="contact" id="contact">
  <div class="row mb-5 text-center">
    <div class="col">
      <h2>
      @if (@$local) @lang('data.title.contact.heading') @else Kontak Kami
        @endif
      </h2>
    </div>
  </div>
  <div class="row mb-3 justify-content-center">
    <div class="col-10 col-lg-8">
      <div id="alertSuccess" class="alert alert-success alert-dismissible fade show d-none ms-5" role="alert">
        ...
        @lang('data.title.contact.form.alert.paragraph.success') @else
      ...
      <div id="alertFailed" class="alert alert-danger alert-dismissible fade show d-none ms-5" role="alert">
        ...
        @lang('data.title.contact.form.alert.paragraph.failed') @else
