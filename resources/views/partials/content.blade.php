        ...
        <div class="row justify-content-around fs-5 text-center">
            ...
            <div class="col-12 col-md-6">
                <p class="align-middle mb-3">
                    <img src="{{ asset('assets/images/icon/discord.png') }}" alt="Discord Logo" width="50"
                        height="50" />
                    @if (@$local)
            ...
            <div class="col-12 col-md-6">
                <p class="align-middle mb-3 pt-3 pt-md-0">
                    <img src="{{ asset('assets/images/icon/twitter.png') }}" alt="Twitter Logo" width="50"
                        height="50" />
                    @if (@$local)
                ...
                <div class="swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                                <iframe class="embed-item-responsive"
                                    src="https://www.youtube.com/embed/dhJyQ97laCg?rel=0"
                        ...
                        <div class="swiper-slide">
                            <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                                <iframe class="embed-item-responsive"
                                    src="https://www.youtube.com/embed/X9zw0QF12Kc?rel=0"
                                    title="Sakura Miko Debut Video" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                                <iframe class="embed-item-responsive"
                                    src="https://www.youtube.com/embed/Y8o4goeVM0o?rel=0"
                                    title="Sakura Miko Debut Video" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                                <iframe class="embed-item-responsive"
                                    src="https://www.youtube.com/embed/HiLnCY9qjSo?rel=0"
                                    title="Sakura Miko Debut Video" allowfullscreen></iframe>
                            </div>
                        </div>
                        <div class="swiper-slide">
                            <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                                <iframe class="embed-item-responsive"
                                    src="https://www.youtube.com/embed/uRB1G0cKpIk?rel=0"
                                    title="Sakura Miko Debut Video" allowfullscreen></iframe>
                            </div>
                        </div>
                        {{-- @endforeach --}}
                        ...
                        <div class="captcha">
                            <div>
                                <iframe
                                    ...
                                    width="304" height="78" role="presentation" name="a-fekub1qv2b0s" frameborder="0"
                                    scrolling="no"
