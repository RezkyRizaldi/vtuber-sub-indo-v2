      ...
      <div class="collapse navbar-collapse" id="navbarNav" style="flex-grow: 0">
        <ul class="navbar-nav ms-auto ps-2 pe-lg-5 pe-xl-0">
          ...
          <li class="nav-item d-none d-lg-block d-xl-block d-xxl-block">
            <a title="{{ @$local ? __('data.link.profile') : 'Username' }}"
              href="{{ url('/') }}">
              <img src="{{ asset('assets/images/default_pfp.png') }}" class="mt-1 ms-1 rounded-circle img-thumbnail" alt="Username" width="30" height="30" />
            </a>
          </li>
          <li class="nav-item d-block d-lg-none d-xl-none d-xxl-none">
            <a class="nav-link text-decoration-none" title="{{ @$local ? __('data.link.profile') : 'Username' }}"
              href="{{ url('/') }}">
              <img src="{{ asset('assets/images/default_pfp.png') }}" class="me-1 rounded-circle img-thumbnail" alt="Username" width="30" height="30" />
              Username
            </a>
          </li>
          <li class="nav-item dropdown mt-2 ms-1 d-none d-lg-block d-xl-block d-xxl-block">
            ...
            <ul class="dropdown-menu dropdown-menu-dark dropdown-menu-lg-end">
              ...
              <li><a class="dropdown-item" href="{{ url('/') }}" title="{{ @$local ? __('data.link.profile') : 'Username' }}">Something else here</a></li>
              <li><hr class="dropdown-divider"></li>
              <li><a class="dropdown-item" href="{{ url('/') }}" title="{{ @$local ? __('data.link.sign_out') : 'Keluar' }}">
              @if (@$local)
