      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal" aria-label="Close"
            data-bs-target="virtualpedia"></button>
        </div>
          ...
          <div class="container-fluid">
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-12 col-md-4">
                      ...
                      <ul class="list-group list-group-flush mobile dark_state">
                      ...
                      <div class="row">
                        <div class="col-md mt-4 mt-md-0">
                          ...
                          <ul class="list-group list-group-flush mobile dark_state">
                            <li class="list-group-item list-group-item-action">
                              &middot; YouTube:
                              <a class="links text-decoration-none" title="Miko Ch. さくらみこ" target="_blank"
                                rel="noopener noreferrer"
                                href="https://www.youtube.com/channel/UC-hM6YJuNYVAmUWxeIr9FeA">Miko
                                Ch. さくらみこ</a>
                            </li>
                            <li class="list-group-item list-group-item-action">
                              &middot; Twitch:
                              <a class="links text-decoration-none" title="sakuramiko_hololive" target="_blank"
                                rel="noopener noreferrer"
                                href="https://twitch.tv/sakuramiko_hololive">sakuramiko_hololive</a>
                            </li>
                            <li class="list-group-item list-group-item-action">
                              &middot; Twitter:
                              <a class="links text-decoration-none" title="@sakuramiko35" target="_blank"
                                rel="noopener noreferrer" href="https://twitter.com/sakuramiko35">@sakuramiko35</a>
                            </li>
                            <li class="list-group-item list-group-item-action">
                              &middot; bilibili:
                              <a class="links text-decoration-none" title="さくらみこ" target="_blank"
                                rel="noopener noreferrer" href="https://space.bilibili.com/366690056/">さくらみこ</a>
                            </li>
                            <li class="list-group-item list-group-item-action">
                              &middot; Website:
                              <a class="links text-decoration-none" title="hololive Official Website" target="_blank"
                                rel="noopener noreferrer"
                                href="https://www.hololive.tv/portfolio/items/336371">hololive.tv
                                (Japanese)</a>
                              |
                              <a class="links text-decoration-none" title="hololive Official Website" target="_blank"
                                rel="noopener noreferrer" href="https://en.hololive.tv/portfolio/items/433578">hololive.tv
                                (English)</a>
                            </li>
                          </ul>
                        </div>
                        <div class="col-md mt-3 mt-md-0">
                          <h2 class="mobile_heading personal_info dark_state">
                        ...
                        <div class="col-md-12 mt-3">
                          ...
                          <div class="ratio ratio-16x9 ratio-4x3 ratio-1x1">
                            <iframe class="embed-item-responsive" src="https://www.youtube.com/embed/lMPhHXJbPEQ?rel=0"
            ...
            <div class="row mt-3 mt-md-0">
              ...
              <div class="col-md-12">
                ...
                <ul class="list-group overflow-auto border border-2 border-dark rounded-3 desktop dark_state">
                  <li class="list-group-item list-group-item-action border-top-0 border-end-0 border-start-0 border-dark">
                    &middot; Background
                    <p class="dark_state">
        ...
        <div class="modal-footer">
          <small class="text-muted me-auto">Fetching from
          ...
          <button type="button" class="btn text-light" data-bs-dismiss="modal" data-bs-target="virtualpedia">
            Gitu, ya.
          </button>
        </div>
      </div>
