        ...
        <div class="row justify-content-around mb-5 pt-3 pt-md-0">
            <div class="col-md-8">
                <div class="d-flex justify-content-evenly">
                    <a class="social" rel="noopener noreferrer" target="_blank"
                        href="https://www.facebook.com/VtuberSubIndo"><img
                            src="{{ asset('assets/images/icon/facebook.png') }}" alt="Facebook Logo"
                            title="Facebook Fanpage" width="50" height="50" /></a>
                    <a class="social" rel="noopener noreferrer" target="_blank"
                        href="https://instagram.com/vtubersubindo"><img
                            src="{{ asset('assets/images/icon/instagram.png') }}" alt="Instagram Logo" title="Instagram"
                            width="50" height="50" /></a>
                    <a class="social" rel="noopener noreferrer" target="_blank"
                        href="https://youtube.com/c/VtuberSubIndo"><img
                            src="{{ asset('assets/images/icon/youtube.png') }}" alt="YouTube Logo" title="YouTube"
                            width="50" height="50" /></a>
                </div>
            </div>
        </div>
        <div class="row justify-content-center">
            <div class="col-8 col-lg-12">
                <p class="{{ Request::is('virtualpedia') || Request::is('en' . '/virtualpedia') ? 'text-dark' : '' }}">
                    ...
                    by <span
                        class="{{ Request::is('virtualpedia') || Request::is('en' . '/virtualpedia') ? 'text-dark' : 'dark_state' }}">Vtuber
                        Sub Indo</span><i class="bi bi-paperclip"></i>All Right
                    Reserved.
                </p>
            </div>
        </div>
